...
/** To be written */
class gasContinuumEmissionSEDFamily : public SEDFamily
{
    ITEM_CONCRETE(gasContinuumEmissionSEDFamily, SEDFamily, "a user-provided list of gas continuum data that make up an SED")
        PROPERTY_STRING(filename, "the name of the stored table file defining the continuum")
    ITEM_END()
