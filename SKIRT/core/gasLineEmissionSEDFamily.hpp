...
/** To be written */
class gasLineEmissionSEDFamily : public SEDFamily
{
    ITEM_CONCRETE(gasLineEmissionSEDFamily, SEDFamily, "a user-provided list of gas line data that make up an SED")
